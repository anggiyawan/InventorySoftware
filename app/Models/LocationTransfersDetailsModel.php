...
class LocationTransfersDetailsModel extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'location_transfers_details';
    ...
    {
		$sql = "SELECT location_transfers_details.* FROM location_transfers_details";
		$sql .= " WHERE location_transfers_details.statusId!=0";
		
		if ( !empty($_GET['id'])) 
		{
			$sql .= " AND location_transfers_details.locationTransferId='" . $_GET['id'] . "'";
		}
		
		if ( isset($_POST['locationName'])) 
		{
			$sql .= " AND location_transfers_details.locationName LIKE '%" . $_POST['locationName'] . "%'";
		}
		
		if ( isset($_POST['remark'])) 
		{
			$sql .= " AND location_transfers_details.remark LIKE '%" . $_POST['remark'] . "%'";
		}
		
		if ( $_POST['statusId'] != null) 
		{
			$sql .= " AND location_transfers_details.statusId='" . $_POST['statusId'] . "'";
		}

...
<head>
	...
	<title>Layout</title>
		...
		<link id="theme_style" rel="stylesheet" type="text/css" href="<?php echo base_url('assets/themes/default/easyui.css?v=4' . VERSION); ?>">
		<link href="<?php echo base_url('assets/css/style.css?v=' . VERSION); ?>" rel="stylesheet" media="screen">
		<link href="<?php echo base_url('assets/themes/icon.css?v=' . VERSION); ?>" rel="stylesheet">	
		<link href="<?php echo base_url('assets/style-modif.css?v=' . VERSION); ?>" rel="stylesheet" media="screen">	
	...
	<script type="text/javascript" src="<?php echo base_url('assets/datagrid-dnd.js?v=' . VERSION); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/js/jquery.customgrid.js?v=' . VERSION); ?>"></script>
<script>
// $(document).on("contextmenu",function(e){e.preventDefault()});
$.parser.onComplete = function(){
	// setup layoutWork
	var layoutWork = sessionStorage.getItem("layoutWork");
	$('#layoutWork').layout(layoutWork,'west');
...
$(function() {
    ...
    var p = $('#layoutWork').layout('panel','west').panel({
        onCollapse:function(){    
			// alert('collapse');
			sessionStorage.layoutWork = 'collapse';
        },
		onExpand:function(){
			// alert('expand');
			sessionStorage.layoutWork = 'expand';
		}
    });

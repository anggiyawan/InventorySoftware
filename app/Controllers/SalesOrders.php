	...
	public function getJson()
    {
		...
		{	
			...
			// }
		        ...
		        $status = "<img src='" . base_url('assets/css/icons/st_green.gif') . "'> Confirm";
			}
			else if ( $data->statusId == \SALES_ORDER_STATUS::PROGRESS ) {
		        $status = "<img src='" . base_url('assets/css/icons/st_green.gif') . "'> Progress";
			}
			else if ( $data->statusId == \SALES_ORDER_STATUS::SHIPMENT ) {
		        $status = "<img src='" . base_url('assets/css/icons/st_green.gif') . "'> Shipment";
			}
			else if ( $data->statusId == \SALES_ORDER_STATUS::CLOSED ) {
		        $status = "<img src='" . base_url('assets/css/icons/st_purple.gif') . "'> Closed";
			}
